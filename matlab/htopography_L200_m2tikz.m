...
disp('------------------------------ Process Smoothed-box data : L = 2.0');
disp(' ');
...
try
  ...
  a = dir('htopography_F*_L200.m');
  b = dir('htopography_F*_L200.mat');
  a1 = cell(1,length(a));
  for k=1:length(a)
...
for F = Fvec
  ...
  try
    ...
    ['if ~exist(''data_F%s_DBL'', ''var'') || RECOMPUTE\n' ...
     '  if exist(''htopography_F%s_DBL_L200.m'', ''file'') || ...\n' ...
     '     exist(''htopography_F%s_DBL_L200.mat'', ''file'')\n' ...
     '    data_F%s_DBL = convert_and_load(''htopography_F%s_DBL_L200'');\n' ...
     '  end\n' ...
     'end\n' ...
     'if exist(''data_F%s_DBL'', ''var'')\n' ...
     '  disp(''Value of N, for F=%f, L = 2.00, DBL soln'');\n' ...
    ...
    ['if ~exist(''data_F%s_DIP'', ''var'') || RECOMPUTE\n' ...
     '  if exist(''htopography_F%s_US2_L200.m'', ''file'') || ...\n' ...
     '     exist(''htopography_F%s_US2_L200.mat'', ''file'')\n' ...
     '    data_F%s_DIP = convert_and_load(''htopography_F%s_US2_L200'');\n' ...
     '  end\n' ...
     'end\n' ...
     'if exist(''data_F%s_DIP'', ''var'')\n' ...
     '  disp(''Value of N, for F=%f, L = 2.00, DIP soln'');\n' ...
    ...
    ['if ~exist(''data_F%s_STD'', ''var'') || RECOMPUTE\n' ...
     '  if exist(''htopography_F%s_US1_L200.m'', ''file'') || ...\n' ...
     '     exist(''htopography_F%s_US1_L200.mat'', ''file'')\n' ...
     '    data_F%s_STD = convert_and_load(''htopography_F%s_US1_L200'');\n' ...
     '  end\n' ...
     'end\n' ...
     'if exist(''data_F%s_STD'', ''var'')\n' ...
     '  disp(''Value of N, for F=%f, L = 2.00, STD soln'');\n' ...
...
while INVALID_SELECTIONS
  ...
  try
    ...
    a = dir('htopography_U*_L200.m');
    b = dir('htopography_U*_L200.mat');
    a1 = cell(1,length(a));
    for k=1:length(a)
      a1{k} = getfield(a, {k}, 'name');
    end
  ...
  if ~isempty(U_avail)
    ...
    try
      ...
      ['if ~exist(''data_U%s_SS1'', ''var'') || RECOMPUTE\n' ...
       '  if exist(''htopography_U%s_SS1_L200.m'', ''file'') || ...\n' ...
       '     exist(''htopography_U%s_SS1_L200.mat'', ''file'')\n' ...
       '    data_U%s_SS1 = convert_and_load(''htopography_U%s_SS1_L200'');\n' ...
       '  end\n' ...
       'end\n' ...
       'if exist(''data_U%s_SS1'', ''var'')\n' ...
       '  disp(''Value of N, for U=%f, L = 2.00, SS1 soln'');\n' ...
      ...
      ['if ~exist(''data_U%s_SS2'', ''var'') || RECOMPUTE\n' ...
       '  if exist(''htopography_U%s_SS2_L200.m'', ''file'') || ...\n' ...
       '     exist(''htopography_U%s_SS2_L200.mat'', ''file'')\n' ...
       '    data_U%s_SS2 = convert_and_load(''htopography_U%s_SS2_L200'');\n' ...
       '  end\n' ...
       'end\n' ...
       'if exist(''data_U%s_SS2'', ''var'')\n' ...
       '  disp(''Value of N, for U=%f, L = 2.00, SS2 soln'');\n' ...
      ...
      ['if ~exist(''data_U%s_DL1'', ''var'') || RECOMPUTE\n' ...
       '  if exist(''htopography_U%s_DL1_L200.m'', ''file'') || ...\n' ...
       '     exist(''htopography_U%s_DL1_L200.mat'', ''file'')\n' ...
       '    data_U%s_DL1 = convert_and_load(''htopography_U%s_DL1_L200'');\n' ...
       '  end\n' ...
       'end\n' ...
       'if exist(''data_U%s_DL1'', ''var'')\n' ...
       '  disp(''Value of N, for U=%f, L = 2.00, DL1 soln'');\n' ...
      ...
      ['if ~exist(''data_U%s_DL2'', ''var'') || RECOMPUTE\n' ...
       '  if exist(''htopography_U%s_DL2_L200.m'', ''file'') || ...\n' ...
       '     exist(''htopography_U%s_DL2_L200.mat'', ''file'')\n' ...
       '    data_U%s_DL2 = convert_and_load(''htopography_U%s_DL2_L200'');\n' ...
       '  end\n' ...
       'end\n' ...
       'if exist(''data_U%s_DL2'', ''var'')\n' ...
       '  disp(''Value of N, for U=%f, L = 2.00, DL2 soln'');\n' ...
