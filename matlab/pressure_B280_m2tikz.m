...
try
  ...
  a = dir('pressure_F*_B280.m');
  b = dir('pressure_F*_B280.mat');
  a1 = cell(1,length(a));
  for k=1:length(a)
...
f3 = @(in_d, i)((in_d.eta_s_mid{i}(1) + ...
                 ((in_d.F{i}^2) * (1 - in_d.u_s_mid{i}(end)))) * ...
                filter_trick(min(in_d.u_s_mid{i}) > MIN_HORZ_VEL));
...
for F = Fvec
  ...
  try
    ...
    ['if ~exist(''data_F%s_DBL'', ''var'') || RECOMPUTE\n' ...
     '  if exist(''pressure_F%s_DBL_B280.m'', ''file'') || ...\n' ...
     '     exist(''pressure_F%s_DBL_B280.mat'', ''file'')\n' ...
     '    data_F%s_DBL = convert_and_load(''pressure_F%s_DBL_B280'');\n' ...
     '  end\n' ...
     'end\n' ...
     'if exist(''data_F%s_DBL'', ''var'')\n' ...
     '  disp(''Value of N, for F=%f, B = 2.80, DBL soln'');\n' ...
    ...
    ['if ~exist(''data_F%s_DIP'', ''var'') || RECOMPUTE\n' ...
     '  if exist(''pressure_F%s_DIP_B280.m'', ''file'') || ...\n' ...
     '     exist(''pressure_F%s_DIP_B280.mat'', ''file'')\n' ...
     '    data_F%s_DIP = convert_and_load(''pressure_F%s_DIP_B280'');\n' ...
     '  end\n' ...
     'end\n' ...
     'if exist(''data_F%s_DIP'', ''var'')\n' ...
     '  disp(''Value of N, for F=%f, B = 2.80, DIP soln'');\n' ...
    ...
    ['if ~exist(''data_F%s_STD'', ''var'') || RECOMPUTE\n' ...
     '  if exist(''pressure_F%s_B280.m'', ''file'') || ...\n' ...
     '     exist(''pressure_F%s_B280.mat'', ''file'')\n' ...
     '    data_F%s_STD = convert_and_load(''pressure_F%s_B280'');\n' ...
     '  end\n' ...
     'end\n' ...
     'if exist(''data_F%s_STD'', ''var'')\n' ...
     '  disp(''Value of N, for F=%f, B = 2.80, STD soln'');\n' ...
