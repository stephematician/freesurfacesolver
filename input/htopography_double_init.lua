...
io.write('1. Find a low-resolution perturbation to double hump solution.\n')
io.flush()
...
_, free_hi_res_dbl, continued_hi_res_dbl = pert_to_double_tables(N_HI_RES, #(hi_res_dbl.N_SUB))
