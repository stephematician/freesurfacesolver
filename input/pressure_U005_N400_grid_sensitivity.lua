...
-- Need to adjust free variables to perform correct continuation.

free_lo_res_sol.FROUDE = false --
free_lo_res_sol.CLUSTER_VAL = true  -- hmm!

continued_lo_res_sol.A = false  -- hmm!
continued_lo_res_sol.CLUSTER_VAL = true  -- hmm!
