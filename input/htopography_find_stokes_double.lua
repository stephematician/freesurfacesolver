stokes_double_tables = function(inN, inN_SUB_length)
...
find_stokes_double = function(inA, inB, inL, inU_MIN, inPHI_LIM, inN, inCLUSTER_VAL, inFROUDE)
  ...
  is_free_dbl.A = true
  is_free_dbl.U_MIN = false
  is_continued_dbl.U_MIN = false
