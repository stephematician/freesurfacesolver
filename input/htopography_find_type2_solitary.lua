type2_single_tables = function(inN, inN_SUB_length)
...
find_type2_solitary = function(inA, inB, inL, inU_MIN, inPHI_LIM, inN, inCLUSTER_VAL, helperFROUDE)
