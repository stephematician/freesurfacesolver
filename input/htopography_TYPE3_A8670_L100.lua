...
dofile('input/htopography_find_type3_solitary.lua')
...
ASTR = string.format('%03u',round(math.abs(TYPE3_A*1000)))
USTR = string.format('%03u',round(STOKES_U_MIN*100))

in_script  = 'input/htopography_type3_solitary_init.lua'

out_file = 'output/htopography_A' .. ASTR .. '_U' .. USTR .. '_TYPE3.m'
...
mesgt = {
  headers = {
    ...
    subject = 'htopography calculation htopography_A' .. ASTR .. '_U' .. USTR .. '_TYPE3.m' 
  },
