find_pert_to_sol = function(inB, finalA, inU_MIN, inPHI_LIM, inN, inCLUSTER_VAL)
  ...
  is_free_sollim.ETA0 = true
  is_free_sollim.U_MIN = false

  is_continued_sollim.A = true
  ...
  for i = 1, num_continuate do
    ...
    if (not initial_step) and
       (math.abs(csurf.A - finalA) < (1.5*ds)) then
    ...
    if started_converge and (i - started_converge_i) > 12 then
      io.write('  Finished.\n')
      break
    end
