...
in_script  = 'input/pressure_stokes_double_init_alt.lua'

out_file = 'output/pressure_A' .. ASTR .. '_U' .. USTR .. '_TYPE4.m'
...
mesgt = {
  headers = {
    ...
    subject = 'pressure calculation pressure_A' .. ASTR .. '_U' .. USTR .. '_TYPE4.m' 
  },
