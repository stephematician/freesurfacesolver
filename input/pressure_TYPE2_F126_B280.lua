...
out_file = 'output/pressure_F' .. FSTR .. '_U' .. USTR .. '_TYPE2.m'
...
mesgt = {
  headers = {
    ...
    subject = 'pressure calculation pressure_F' .. FSTR .. '_U' .. USTR .. '_TYPE2.m' 
  },
...
for i = 1, num_continuate, 1 do
  ...
  if (math.abs(csurf.U_MIN) > STOKES_U_MAX) then
    mesgt.body = mesgt.body .. 
