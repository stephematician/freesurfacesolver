...
History:
20/06/2014 Included the latest changes to the format from htopography work
           in particular the output file and garbage collection.
...
out_file_sl1 = 'output/pressure_U010_SL1_B280.m'
out_file_sl2 = 'output/pressure_U010_SL2_B280.m'
out_file_dbl = 'output/pressure_U010_DBL_B280.m'
