type3_single_tables = function(inN, inN_SUB_length)
...
find_type3_solitary = function(inA, inB, inL, inU_MIN, inPHI_LIM, inN, inCLUSTER_VAL, helperFROUDE)
  ...
  local helperETA0      = (4/3)*(helperFROUDE - 1)
  ...
  io.write('to a wave with A = ', inA, '. Then find a  sol. wave solution with\n')
  ...
  local _, is_free_help, is_continued_help = type3_single_tables(inN, #initial_help.N_SUB);
...
--  is_continued_help.U_MIN = true
  ...
  io.write('     PHI_C : ', initial_sol.PHI_C, '.\n\n')
