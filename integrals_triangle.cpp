...
extern "C" int luaopen_integrals_triangle(lua_State *);
static int tau_s(lua_State*);
static int tau_b(lua_State*);

static int y_s(lua_State*);
static int y_b(lua_State*);
static int x_s(lua_State*);
...
int luaopen_integrals_triangle(lua_State *L) {
