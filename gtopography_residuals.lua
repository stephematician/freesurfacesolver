...
module("gtopography_residuals", package.seeall)
...
compute_bttxe_hs = function(unpacked, x_calculation)
  ...
  local tau_s_mid = integrals_sbox.tau_gaussian_symmetric_s(theta_s,    phi_sub,
                                                           dphi_sub,     beta_s,
                                                           beta_sub,          A,
                                                                  B,          L,
                                                                  D,     lambda,
...
compute_bttxe_hg = function(unpacked)
  ...
  local tau_s_mid = integrals_sbox.tau_gaussian_s(theta_s,   phi_sub,
                                                 dphi_sub,    beta_s,
                                                 beta_sub,         A,
                                                        B,         L,
                                                D_dstream, D_ustream,
...
residual_hs = function(unknowns, extra)
  ...
  if print_out then
    io.write('gtopography_residuals.residual_hs entry point ... \n')
    io.flush()
  end
  ...
  -- (N+2) + #crests
  -- Geometry equations
  local x_b = integrals_sbox.x_gaussian_symmetric_b({phi_c},  theta_s,
                                                     beta_s,  phi_sub,
                                                   dphi_sub, beta_sub,
                                                          A,        B,
                                                          L,        D,
